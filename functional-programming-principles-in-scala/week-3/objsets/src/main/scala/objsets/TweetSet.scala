...
class NonEmpty(elem: Tweet, left: TweetSet, right: TweetSet) extends TweetSet {
  ...
  override def mostRetweeted: Tweet = {
    ...
    lazy val leftTop = left.mostRetweeted
    lazy val rightTop = right.mostRetweeted

    (left.isEmpty, right.isEmpty) match {
      case (true, true) => elem
      case (false, true) => elem.moreRetweeted(leftTop)
      case (true, false) => elem.moreRetweeted(rightTop)
      case (false, false) => elem.moreRetweeted(rightTop).moreRetweeted(leftTop)
    }
